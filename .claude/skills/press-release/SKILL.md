...
## Voice
Wire-ready, professional. Energetic, sharp, smart, clear, confident, generous, alliance-driven. Mirror MMA house style: minimal headers, italicized report names, restrained bullets, confident evidence-anchored language. One vivid phrase per release is acceptable when tied to a stat or quote.
...
4. Dateline city and date (default: **New York, NY — [today's date] —**)
...
- Weave in key themes and insights naturally
- Short paragraphs: 1–3 sentences each

### 5. Quotes (1–2 total, placed naturally — no "Quotes" header)
- **Project lead quote:** Authoritative, specific, practical, data-grounded. Identify lead and title via web search if needed.
- **Greg Stuart quote (MMA CEO):** Plainspoken, pragmatic, growth-oriented, alliance-minded. Direct "we" voice. No buzzwords.
...
- Precede with a setup line ending in a colon (e.g., "Key findings:", "Notable insights:", "Quantitative takeaways:")

### 7. CTA
- Single sentence with exact report/hub/event URL (or placeholder)
- No separate header

### 8. About MMA Boilerplate (word-for-word, no quotation marks)
...
### 9. Media Contact
Each field on its own line. Default if none provided:
...
- **Exclamation points:** Only in brand names
...
- Keep qualifiers tight. Use specific comparisons ("higher ROI than linear TV in this sample").
...
- Write for a busy CMO. Each paragraph delivers one idea.
- AP style leaning.

## Terms to Avoid

Unlock, Unleash, Synergy, Uncover, Furthermore, Leverage (verb), Landscape, Delve, Prowess, Realm, Unearth, Tapestry, Crucial, Critical, Pivotal, Revolutionary, Lifeblood, Treasure trove, Dive into, Game-changing, Cutting edge, Empower (as cliché), "Not only [...], but also", Paradigm shift, Best-in-class, Seamless.

Retain only if part of a proper noun or title. Otherwise rewrite.
...
- Page 3, Methodology: "Global survey of 389 senior marketers; fielded Apr–May 2025"
...
- [ ] Lede answers 5Ws in ≤45 words
- [ ] Headlines ≤100 chars, subheads ≤150 chars
...
- [ ] MMA naming conventions followed (Marketing + Media Alliance on first mention)

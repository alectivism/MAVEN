...
Apify connector with the shared MMA token. **Setup:** open [Apify Scraping Setup for Claude MMA](https://mmaglobalcom.sharepoint.com/:w:/s/MMAGlobal/IQCxuNjI070YQ629dqM9p9arAQ0VfeMXGCTEsspdWz19az0?e=pFW5Fz) (MMA Internal › General › AI MMA Upskilling › AI Tool Onboarding for Staff). Pattern: `call-actor` (`waitSecs: 45`) → `get-dataset-items` (always project `fields=`). Full recipes: `SKILL-apify-prior.md`.
